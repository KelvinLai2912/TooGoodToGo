...
// sql user database
var userConnectionString = builder.Configuration.GetConnectionString("SecurityDb");
...
using (var scope = app.Services.CreateScope())
{
    ...
    var dbContext2 = scope.ServiceProvider.GetRequiredService<SecurityDbContext>();
